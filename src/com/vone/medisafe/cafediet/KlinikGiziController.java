...
public class KlinikGiziController  extends BaseController {
...
//	public Button btnEnd;
	...
	public LaboratManager labServ  = Service.getLaboratManager();
	...
	public void init(Component win) throws InterruptedException, VONEAppException {
		...
		clinicList = (Listbox)win.getFellow("clinicList");
...
//		btnEnd.setDisabled(true);
		...
		MRNumber.focus();
		clinicList.setAttribute("jumlah", total);
		total.setFormat("#,###.##");
	...
	public void checkRegistration(Component win) {
		...
		if (isRanap) {
			...
			session.setAttribute("listbox", clinicList);
	...
	public void getRegistration(int type) throws VONEAppException {
		...
		radiologyManager.getRegistrationKlinik(this, type);
	...
	public void cancelNote() throws VONEAppException {
		...
		String permission = super.getUserInfoBean().getScreenPermission(ScreenConstant.TRANSAKSI_KLINIK_GIZI);
...
//				btnCancelNote, statusNota, siu };
	...
	public void getNoteDetail() throws VONEAppException {
		...
		radiologyManager.getNoteDetailKlinik(this);
	...
	public void delete() throws InterruptedException {
		if (clinicList.getSelectedItem() == null) {
			Messagebox.show(MessagesService
					.getKey("common.modify.list.notselected"));
			return;
		}

		int index = clinicList.getSelectedIndex();
...
//				itemTrx.setNQty(((Double)obj[3]).floatValue());
	...
	public void modify() throws VONEAppException{
		...
		Listbox polyclinicList = clinicList;
	...
	public void saveModify() throws VONEAppException, InterruptedException
	{
		...
		Listbox polyclinicList =  this.clinicList;
		List<Listitem> items = polyclinicList .getItems();
		for(Listitem item : items){
