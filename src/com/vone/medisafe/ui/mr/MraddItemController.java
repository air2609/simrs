...
public class MraddItemController extends BaseController{
	...
	public void init(Component win) throws InterruptedException, VONEAppException {
		...
		listbox = (Listbox)session.getAttribute("listObatDokter");
		isRajal = (Boolean)listbox.getAttribute("isRajal");
...
//			Object[] obj = new Object[]{new BigDecimal(hargaFinal),new BigDecimal(hargaFinal),"RP",jumlahValue.getValue(),decimalbox.getValue(),jasaR};
			...
			//decimalbox.addEventListener("onChange", new DiscontListener(listitem,diskonList,finalPrice,decimalbox,listcell,jumlahValue.getValue()));
			//diskonList.addEventListener("onSelect", new DiscontListener(listitem,diskonList,finalPrice,decimalbox,listcell, jumlahValue.getValue()));
