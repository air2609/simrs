...
/**
 * TbUserPrivilege generated by MyEclipse - Hibernate Tools
 */
...
public class TbUserPrivilege  implements java.io.Serializable {
	...
	/** minimal constructor */
    public TbUserPrivilege(TbUserPrivilegeId id, String VAccessType) {
        this.id = id;
        this.VAccessType = VAccessType;
    }
    
    /** full constructor */
    public TbUserPrivilege(TbUserPrivilegeId id, String VAccessType, String VWhocreate, Date DWhncreate, String VWhochange, Date DWhnchange) {
        this.id = id;
        this.VAccessType = VAccessType;
